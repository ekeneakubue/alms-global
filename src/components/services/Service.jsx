  ...
  return (
    <div className='container'>
        <div className="service">
            ...
            <div className="row">
                <div className="col-md-4 service-bg-light" data-aos="fade-right" data-aos-duration="2000">
                    <i class="bi bi-bank2 text-danger"></i>
                    <div>Study/Work Permits</div>
                </div>
                <div className="col-md-4 service-bg-white">
                    <i class="bi bi-airplane-engines-fill text-danger"></i>
                    <div>Visitor/Travel Visas</div>
                </div>
                <div className="col-md-4 service-bg-light" data-aos="fade-left" data-aos-duration="2000">
                ...
                <div className="col-md-4 service-bg-light">
